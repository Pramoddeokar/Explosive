 ...
 * ```html
 * <a ui-sref="http://www.gravatar.com/avatar/{{hash}}">link1</a>
 * ```
 *
 * @element A
 ...
 *
 * @example
 * This example shows various combinations of `href`, `ui-sref` and `ng-click` attributes
 * in links and their different behaviors:
    <example>
      <file name="index.html">
        ...
        <a id="link-3" ui-sref="/{{'123'}}">link 3</a> (link, reload!)<br />
        <a id="link-4" href="" name="xx" ng-click="value = 4">anchor</a> (link, don't reload)<br />
        <a id="link-5" name="xxx" ng-click="value = 5">anchor</a> (no link)<br />
        <a id="link-6" ui-sref="{{value}}">link</a> (link, change location)
      </file>
      <file name="protractor.js" type="protractor">
        ...
        it('should execute ng-click and change url when ui-sref specified', function() {
        ...
        it('should only change url when only ui-sref', function() {
...
// ng-src, ng-srcset, ui-sref are interpolated
